...
{
    [Authorize]
    public class MaintenanceActionQualityController : Controller
    {
        ...
        {
            var sql = "select * from wv_grey_insp_defect_master " +
                "where defect_code LIKE 'W%' " +
                "order by defect_name asc ";
            var data = db.Database.SqlQuery<wv_grey_insp_defect_master>(sql);
            var no = data.ToList();
        ...
        public ActionResult Index()
        {
            ...
            var sql = "select * from vw_ms_maintenance_action_quality " +
                "where mtc_id = '" + mtcId + "' " +
                "order by troubelName asc ";
            var datas = db.Database.SqlQuery<vw_ms_maintenance_action_quality>(sql).ToList();
        ...
        public ActionResult Index(FormCollection act)
        {
            ...
            var sql = "select * from vw_ms_maintenance_action_quality " +
                ...
                "order by troubelName asc ";
            var filter = db.Database.SqlQuery<vw_ms_maintenance_action_quality>(sql).ToList();
        ...
        // GET: MaintenanceActionQuality/Create
        ...
        public ActionResult Create([Bind(Include = "department, machine, troubelName, mtcActionName, dept_id, mc_id, trouble_id, mtc_action_id, mtc_id, mtc_action_name")] vw_ms_maintenance_action_quality main)
        {
            InitializeUserAkses();
        ...
        public ActionResult Edit(int? dept, int? mc, string mtc, string trouble, string act)
        {
            ...
            var ms = db.Database.SqlQuery<vw_ms_maintenance_action_quality>(sql).FirstOrDefault();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "department, machine, troubelName, mtcActionName, dept_id, mc_id, trouble_id, mtc_action_id, mtc_id, mtc_action_name")] vw_ms_maintenance_action_quality main)
        {
            InitializeUserAkses();
        ...
        public ActionResult DeleteConfirmed(int? dept, int? mc, string mtc, string trouble, string act)
        {
            ...
            //Check trouble id di shift leader notes
