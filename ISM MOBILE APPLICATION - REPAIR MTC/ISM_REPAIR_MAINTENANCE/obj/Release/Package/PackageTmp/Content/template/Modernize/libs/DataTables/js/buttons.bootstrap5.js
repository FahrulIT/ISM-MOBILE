...
$.extend(true, DataTable.Buttons.defaults, {
	dom: {
		...
		split: {
			action: {
				tag: 'a',
				className: 'btn btn-rounded btn-outline-primary dt-button-split-drop-button',
				closeButton: false
			},
			dropdown: {
				tag: 'button',
				dropHtml: '',
				className:
					'btn btn-rounded btn-outline-primary dt-button-split-drop dropdown-toggle dropdown-toggle-split',
				closeButton: false,
				align: 'split-left',
